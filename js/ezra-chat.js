...
(function () {
    ...
    const EZRA_KNOWLEDGE = {
        ...
        localDocuments: [
            ...
            { category: 'competitive', title: 'HELOC vs Cash-Out Refinance', content: 'HELOC wins when: Client has a good first mortgage rate they want to keep. Faster process (5 days vs 30-45 days for refi). Lower closing costs. No appraisal in most cases (AVM instead). Access funds as needed vs lump sum. Keep existing mortgage intact. Frame: "Why would you give up your 3.5% first mortgage just to access equity? A HELOC lets you keep that rate AND access your cash."' },
            { category: 'competitive', title: 'HELOC vs Personal Loan', content: 'HELOC wins: Much lower rate (8% vs 12-18%). Higher limits ($50K-$500K+ vs $15-50K). Interest may be tax-deductible (consult tax advisor). Longer terms available. No prepayment penalty. Frame: "A personal loan is unsecured, so you pay a premium for that. Your home equity is collateral — that\'s why the rate is so much lower."' },
            { category: 'competitive', title: 'HELOC vs Credit Cards', content: 'HELOC wins: Fraction of the rate (8% vs 22-29%). Structured payoff schedule vs revolving minimum payments. $100K at 24% CC = ~$2,000/mo minimum, takes 30+ years. Same $100K HELOC at 8% for 15yr = ~$956/mo, paid in 15 years. Total savings: Over $100,000+ in interest. Frame: "You\'re already paying for this equity — why pay 24% when you could pay 8%?"' },
